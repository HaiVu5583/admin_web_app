const Toast = (props) => {
  ...
  if (type == "success")
    return (
      <div class="flex items-center bg-green-500 border-l-4 border-green-700 py-2 px-3 shadow-md mb-2 z-50">
  ...
  if (type == "primary")
    return (
      <div class="flex items-center bg-blue-400 border-l-4 border-blue-700 py-2 px-3 shadow-md mb-2 z-50">
